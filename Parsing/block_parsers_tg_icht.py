...
class Telegram_parser_icht():

    # URL страницы канала Telegram
    channel_url = "https://t.me/s/klgtu_digital_channel"
    ...
    parser_id = 'Telegram_parser_icht'
    ...
    df = pd.DataFrame({'url': news_urls, 'parser': parser_id, 'source': source, 'topic_block': 'tg_icht', 'parsing_date': parsing_date, 'public_date': post_time, 'title': title, 'context': news_data, 'raw_html': str(html), 'is_document': is_document})
