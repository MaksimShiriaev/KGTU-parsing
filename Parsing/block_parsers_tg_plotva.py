...
class Telegram_parser_plotva():
    ...
    parser_id = 'Telegram_parser_plotva'
    ...
    df = pd.DataFrame({'url': news_urls, 'parser': parser_id, 'source': source, 'topic_block': 'tg_plotva', 'parsing_date': parsing_date, 'public_date': post_time, 'title': title, 'context': news_data, 'raw_html': str(html), 'is_document': is_document})
